...
class Bloque:
    def __init__(self, cx, cy, texto, es_correcto):
        ...
        self.activo = True
        self.sacudida = 0     # frames de efecto de sacudida
        self.destello = 0     # frames de efecto de destello
    ...
    def sacudir(self):
        self.sacudida = 25   # frames de vibración

    def destellar(self):
        self.destello = 20   # frames de destello
    ...
    def _ajustar_texto(self, fuente):
        """Divide el texto en líneas que caben dentro del bloque."""
    ...
    def dibujar(self, pantalla, fuente):
        ...
        color_borde  = NEGRO_PURO if self.sacudida > 0 else NEGRO_PURO

        if self.destello > 0:
            if (self.destello // 3) % 2 == 0:
                color_fondo = VERDE
                color_borde = NEGRO_PURO
            else:
