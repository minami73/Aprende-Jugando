# ============================================================
#  screens.py  –  Pantallas de inicio y fin del juego
#  ¡Casi todo está listo! Solo faltan algunos detalles
# ============================================================
...
class PantallaInicio:
    ...
    def dibujar(self):
        ...
        # PISTA: El botón tiene fondo verde, ¿quieres cambiar el color?
...
class PantallaFin:
    ...
    def dibujar(self, gano, puntaje, total):
        ...
        if gano:
            ...
            # PISTA: ¿Qué color tiene el mensaje de "Sigue practicando"?
        ...
        for btn, label in [(self.btn_reiniciar, "Reiniciar"),
            ...
            # PISTA: Borde negro de 3px
            pygame.draw.rect(self.pantalla, NEGRO, btn, 3, border_radius=12)
...
# ============================================================
#  💡 TAREA: Personaliza los textos
#  - Cambia "Aprende Jugando" por otro título
#  - Cambia "Finanzas" por otra materia
#  - Cambia los créditos con tu nombre
# ============================================================